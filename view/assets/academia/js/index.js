$(document).ready(function(){
    $("#user-edit").on('show.bs.modal', function(event) {
        ...
        $('#btn-edit').on('click', function(e) {
            ...
            if (dni==new_dni && name==new_name && last_name==new_last_name && phone_number==new_phone_number && email==new_email && type==new_type) {
                    ...
                    success: function(response) {
                        ...
                        if (jsonData.success == "1") {
                            ...
                            let row = `
                                ...
                                <td>${type}</td>
                                <td>
                                    <a class='button-o button-sm button-rounded button-blue hover-fade' data-toggle='modal' data-target='#user-edit' data-id_row='${id_row}' data-id='${id}' data-dni='${new_dni}' data-name='${new_name}' data-last_name='${new_last_name}' data-phone_number='${new_phone_number}' data-email='${new_email}' data-type='${new_type}'>Modificar</a>&nbsp;
