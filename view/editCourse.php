<div class="container pt70">
    ...
    <form id="course-create-form">
        ...
        <?php
            ...
            echo "<br>";
            echo "<br>";
            echo "Módulos: <span class='color-pasific'>(*)</span>";
            echo "<br>";
            echo "<div id='course-create-modules'>";
                echo "<div class='row-modules'>";
                    ...
                    echo "<a class='delete-course-create-modules button-3d button-xs button-circle button-danger'><i class='fa fa-close'></i></a>";
                echo "</div>";
            echo "</div>";
