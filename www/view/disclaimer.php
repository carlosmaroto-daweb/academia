...
<html lang="es">
    <head>
        <title>Academia Cartabón | Aviso legal</title>
        <meta charset="utf-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="wow fadeInUpShort" data-wow-delay=".1s">
                                <h1 class="hs-line-7 mb-20 mb-xs-10">Aviso legal</h1>
                            </div>
                            <div class="wow fadeInUpShort" data-wow-delay=".2s">
                                <p class="hs-line-6 opacity-075 mb-20 mb-xs-0">
                                    Conoce el funcionamiento de nuestra web y los datos relacionados
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mt-30 wow fadeInUpShort" data-wow-delay=".1s">
                            <div class="mod-breadcrumbs text-end">
                                <a href="index.php">Inicio</a>&nbsp;<span class="mod-breadcrumbs-slash">•</span>&nbsp;<span>Aviso legal</span>
                            </div>                                
                        </div>
