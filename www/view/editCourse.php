    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
            ...
            <section class="page-section">
                <div class="container">
                    <div id="course-create-form" class="form contact-form">
                        ...
                        <label for="course-create-studies">Estudios <span class="required-field-color">(*)</span></label>
                        ...
                        <br>
                        <br>
                        Foto de cabecera <span class="required-field-color">(*)</span>
                        <br>
                        <input type="file" id="header_image" name="header_image" accept=".jpg, .jpeg, .png" />
                        <img id="header_image_preview">
                        <br>
                        <br>
                        Contenido previsualización <span class="required-field-color">(*)</span>
                        <br>
                        <div id="preview"></div>
                        <br>
                        <br>
                        Contenido <span class="required-field-color">(*)</span>
                        <br>
                        <div id="content"></div>
                        <?php
                            echo "<br>";
                            echo "<br>";
                            echo "Fecha inicio <span class='required-field-color'>(*)</span>";
                            echo "<br>";
                            $date = getdate();
                            $year = $date['year'];
                            ...
                            echo "<br>";
                            echo "<br>";
                            echo "Fecha fin <span class='required-field-color'>(*)</span>";
                            echo "<br>";
                            $date = getdate();
                            $year = $date['year'];
                            $mon = str_pad($date['mon'], 2, "0", STR_PAD_LEFT);
                            ...
                            echo "<br>";
                            echo "<br>";
                            echo "Módulos <span class='required-field-color'>(*)</span> (en caso de precio 0 el acceso es gratuito solo a los registrados)";
                            echo "<br>";
                            ...
                            echo "<br>";
                            echo "<br>";
                            echo "Alumnos <span class='required-field-color'>(*)</span>";
                            echo "<br>";
                            ...
                            echo "<br>";
                            echo "<br>";
                            echo "Profesores <span class='required-field-color'>(*)</span>";
                            echo "<br>";
                            echo "<select class='alumn' multiple>";
