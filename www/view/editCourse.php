                ...
                echo "<section class='page-section'>";
                    echo "<div class='container'>";
                        echo "<form id='course-create-form' class='form'>";
                            ...
                            echo "</div>";
                            echo "<div class='form-group'>";
                                echo "<label>Asignatura <span class='required-field-color'>(*)</span></label>";
                                echo "<select class='assigned_subjects input-md round form-control'>{$options_subjects}</select>";
                            echo "</div>";
                            echo "<div class='form-group'>";
                            ...
                            echo "<div class='form-group'>";
                                ...
                                echo "<input id='start' type='date' value='{$year}-{$mon}-{$day}' class='input-md round form-control'>";
                            echo "</div>";
                            echo "<div class='form-group'>";
                                echo "<label for='finish'>Fecha Fin <span class='required-field-color'>(*)</span></label>";
                                $date = getdate();
                                $year = $date['year'];
                                $mon = str_pad($date['mon'], 2, "0", STR_PAD_LEFT);
                                $day = str_pad($date['mday'], 2, "0", STR_PAD_LEFT);
                                echo "<input id='finish' type='date' value='{$year}-{$mon}-{$day}' class='input-md round form-control'>";
                            echo "</div>";
                        echo "</form>";
