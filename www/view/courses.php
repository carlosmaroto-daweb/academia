                    ...
                    <div class="col-md-9 col-md-push-3 mt25">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 mb50">
                                <h4 class="blog-title"><a href="blog-posts-three-left-sb-2col.html#">Amazing Blog Post One</a></h4>
                                <div class="blog-three-attrib">
                                    <span class="icon-calendar"></span>Dec 15 2015 | 
                                    <span class=" icon-pencil"></span><a href="blog-posts-three-left-sb-2col.html#">Harry Boo</a>
                                </div>
                                <img src="view/assets/img/blog/img-blog-1.jpg" class="img-responsive" alt="image blog">
                                <p class="mt25">
                                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos.                            
                                </p>
                                <a href="blog-posts-three-left-sb-2col.html#" class="button button-gray button-xs">Read More <i class="fa fa-long-arrow-right"></i></a>

                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 mb50">
                                <h4 class="blog-title"><a href="blog-posts-three-left-sb-2col.html#">Amazing Blog Post Two</a></h4>
                                <div class="blog-three-attrib">
                                    <span class="icon-calendar"></span>Dec 15 2015 | 
                                    <span class=" icon-pencil"></span><a href="blog-posts-three-left-sb-2col.html#">Harry Boo</a>
                                </div>
                                <img src="view/assets/img/blog/img-blog-2.jpg" class="img-responsive" alt="image blog">
                                <p class="mt25">
                                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos.                            
                                </p>
                                <a href="blog-posts-three-left-sb-2col.html#" class="button button-gray button-xs">Read More <i class="fa fa-long-arrow-right"></i></a>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 mb50">
                                <h4 class="blog-title"><a href="blog-posts-three-left-sb-2col.html#">Amazing Blog Post Three</a></h4>
                                <div class="blog-three-attrib">
                                    <span class="icon-calendar"></span>Dec 15 2015 | 
                                    <span class=" icon-pencil"></span><a href="blog-posts-three-left-sb-2col.html#">Harry Boo</a>
                                </div>
                                <img src="view/assets/img/blog/img-blog-4.jpg" class="img-responsive" alt="image blog">
                                <p class="mt25">
                                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos.                            
                                </p>
                                <a href="blog-posts-three-left-sb-2col.html#" class="button button-gray button-xs">Read More <i class="fa fa-long-arrow-right"></i></a>
